...
Public Class SQLiteDatabase
    ...
    ''    'A magyar dátum és időforma miatt 2016.07.31. 08:00:45
    ''    dbConnection = "Data Source=WIWEdevices.s3db;version=3;new=False;datetimeformat=CurrentCulture"
    ''End Sub
    ...
    Public Sub New(inputFile As [String])
        'A magyar dátum és időforma miatt 2016.07.31. 08:00:45
        dbConnection = [String].Format("Data Source={0};version=3;new=False;datetimeformat=CurrentCulture", inputFile)
    End Sub
